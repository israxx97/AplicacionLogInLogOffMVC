<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <a class="navbar-brand" href="#" onclick="return false">Ventana de logueo</a>
    <button id="botonLogIn" class="btn btn-secondary my-2 my-sm-0 btn-sm" data-toggle="modal" data-target="#ventanaModal" aria-controls="navbarColor01" aria-expanded="false" aria-label="Toggle navigation">
        Log In
    </button>
</nav>
